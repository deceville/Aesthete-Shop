                                        ...
                                        <div className="row">
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">Animals Life</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">Olio Madu</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">Soad Humber</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">War Of Dragon</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">New World</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                            ...
                                            <div className="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                                ...
                                                <div className="product__content content--center content--center">
                                                    <h4><Link to="/single-product">Our World</Link></h4>
                                                    <ul className="prize d-flex">
                                                        <li>$50.00</li>
                                                        <li className="old_prize">$35.00</li>
                                                    </ul>
                                    ...
                                    <div className="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
                                        <div className="list__view__wrapper">
                                            ...
                                            <div className="list__view">
                                                <div className="thumb">
                                                    <Link className="first__img" to="/single-product"><img src="images/product/1.jpg" alt="product images" /></Link>
                                                    <Link className="second__img animation1" to="/single-product"><img src="images/product/2.jpg" alt="product images" /></Link>
                                                </div>
                                                <div className="content">
                                                    <h2><Link to="/single-product">Ali Smith</Link></h2>
                                                    <ul className="rating d-flex">
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                            ...
                                            <div className="list__view mt--40">
                                                <div className="thumb">
                                                    <Link className="first__img" to="/single-product"><img src="images/product/2.jpg" alt="product images" /></Link>
                                                    <Link className="second__img animation1" to="/single-product"><img src="images/product/4.jpg" alt="product images" /></Link>
                                                </div>
                                                <div className="content">
                                                    <h2><Link to="/single-product">Blood In Water</Link></h2>
                                                    <ul className="rating d-flex">
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                            ...
                                            <div className="list__view mt--40">
                                                <div className="thumb">
                                                    <Link className="first__img" to="/single-product"><img src="images/product/3.jpg" alt="product images" /></Link>
                                                    <Link className="second__img animation1" to="/single-product"><img src="images/product/6.jpg" alt="product images" /></Link>
                                                </div>
                                                <div className="content">
                                                    <h2><Link to="/single-product">Madeness Overated</Link></h2>
                                                    <ul className="rating d-flex">
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                            ...
                                            <div className="list__view mt--40">
                                                <div className="thumb">
                                                    <Link className="first__img" to="/single-product"><img src="images/product/4.jpg" alt="product images" /></Link>
                                                    <Link className="second__img animation1" to="/single-product"><img src="images/product/6.jpg" alt="product images" /></Link>
                                                </div>
                                                <div className="content">
                                                    <h2><Link to="/single-product">Watching You</Link></h2>
                                                    <ul className="rating d-flex">
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                            ...
                                            <div className="list__view mt--40">
                                                <div className="thumb">
                                                    <Link className="first__img" to="/single-product"><img src="images/product/5.jpg" alt="product images" /></Link>
                                                    <Link className="second__img animation1" to="/single-product"><img src="images/product/9.jpg" alt="product images" /></Link>
                                                </div>
                                                <div className="content">
                                                    <h2><Link to="/single-product">Court Wings Run</Link></h2>
                                                    <ul className="rating d-flex">
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
                                                        <li className="on"><i className="fa fa-star-o" /></li>
