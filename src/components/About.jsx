                                    ...
                                    <div className="skill-container">
                                        ...
                                        <div className="single-skill">
                                            ...
                                            <div className="progress">
                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".5s" role="progressbar" aria-valuenow={90} aria-valuemin={0} aria-valuemax={100} style={{ width: '90%' }}><span className="pen-lable" />
                                                </div>
                                            </div>
                                        </div>
                                        {/* End single skill */}
                                        ...
                                        <div className="single-skill">
                                            <p>Popular Authors</p>
                                            <div className="progress">
                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".5s" role="progressbar" aria-valuenow={95} aria-valuemin={0} aria-valuemax={100} style={{ width: '95%' }}><span className="pen-lable" />
                                                </div>
                                            </div>
                                        </div>
                                        {/* End single skill */}
                                        ...
                                        <div className="single-skill">
                                            ...
                                            <div className="progress">
                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".5s" role="progressbar" aria-valuenow={93} aria-valuemin={0} aria-valuemax={100} style={{ width: '93%' }}><span className="pen-lable" />
                                                </div>
                                            </div>
                                        </div>
                                        {/* End single skill */}
                                ...
                                <div className="wn__team">
                                    ...
                                    <div className="content text-center">
                                        ...
                                        <ul className="team__social__net">
                                            ...
                                            <li><a href="#"><i className="icon-social-tumblr icons" /></a></li>
